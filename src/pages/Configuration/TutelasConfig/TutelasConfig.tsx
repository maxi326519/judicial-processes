...
import { TutelasConfig as TutelasConfiguration, initTutelasConfig } from "../../../interfaces/configuraiton/tutelas";
...
const inputs: Inputs[] = [
    ...
    { name: "observacionFallo1raInst", label: "Observación del fallo de la 1ra instancia " },
    { name: "terminoCumplimiento1raInst", label: "Término de cumplimiento de la 1ra instancia " },
    { name: "cumplimiento1raInst", label: "Cumplimiento de la 1ra instancia " },
    { name: "fechaCumplimiento1raInst", label: "Fecha de cumplimiento de la 1ra instancia" },
    ...
    { name: "observacionFallo2daInst", label: "Observación fallo de la 2da instancia " },
    { name: "terminoCumplimiento2daInst", label: "Término de cumplimiento de la 2da instancia " },
    { name: "cumplimiento2daInst", label: "Cumplimiento de la 2da instancia " },
    { name: "fechaCumplimiento2daInst", label: "Fecha cumplimiento de la 2da instancia" },
...
export function TutelasConfig() {
    ...
    const [config, setConfig] = useState<TutelasConfiguration>(initTutelasConfig());
