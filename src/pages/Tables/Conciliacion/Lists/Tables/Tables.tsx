...
import { ConciliacionesList } from "../../../../../interfaces/Conciliaciones/list";
import { RootState } from "../../../../../interfaces/RootState";
import {
  deleteItem,
  setItem,
} from "../../../../../redux/actions/Conciliaciones/lists";
...
export default function Tables({
  ...
  const lists: ConciliacionesList = useSelector(
    (state: RootState) => state.conciliaciones.lists
  );
