...
import { RequirementsLists } from "../../../../../interfaces/Requirements/lists";
import {
  deleteItem,
  setItem,
} from "../../../../../redux/actions/Requirements/lists";
...
export default function Tables({
  ...
  const lists: RequirementsLists = useSelector(
    (state: RootState) => state.requirements.lists
  );
